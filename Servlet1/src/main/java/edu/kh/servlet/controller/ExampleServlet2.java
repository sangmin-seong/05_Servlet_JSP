 ...
 * 1. HttpServlet 상속받기 
 * 
 * 2. @WevServlet("요청주소") 어노테이션 작성하기
 * 
 * 3. doGET() 또는 doPost() 오버라이딩 하기
 */


// 어노테이션(Annotation) : 컴파일러 읽고 해석하는 주석

// @WebServlet("요청주소") 어노테이션
// - 컴파일 시 web.xml파일에 해당클래스를 Servlet으로 등록하는 <servlet> 태그 작성하고,
//   "요청 주소"와 매핑되도록 <servlet-mapping>태그 작성하게 함

// *** 주의 사항 ***
// 요청주소는 반드시 "/"부터 시작해야 한다!!!!
@WebServlet("/ex2")
